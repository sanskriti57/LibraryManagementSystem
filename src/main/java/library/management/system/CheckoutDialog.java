...
public class CheckoutDialog extends JDialog {
	    public CheckoutDialog(JFrame parent, BookDAO bookDAO, TransactionDAO transactionDAO, User user) {
	        ...
	        checkoutBtn.addActionListener(e -> {
	            try {
	                ...
	                bookDAO.checkOutBook(bookId);
	                transactionDAO.logIssue(user.getId(), bookId, new java.sql.Date(System.currentTimeMillis()), new java.sql.Date(System.currentTimeMillis() + 7 * 86400000L));
